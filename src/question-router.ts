          ...
          content: [
            {
              ...
              text: [
                ...
                'Use direct_answer for questions about architecture, integration status, runtime status, recent activity, capabilities, skills/tools, or model setup.',
                'Use clarify only when the message is too vague to answer from the provided local context.',
                'Return JSON only: {"route":"direct_answer"|"clarify"|"coding_task","intent":"architecture"|"integration_status"|"runtime_status"|"recent_activity"|"capabilities"|"skills_tools"|"model_setup"|"general","reason":"short optional reason"}.',
